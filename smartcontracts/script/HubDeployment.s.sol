...
contract HubDeployment is Script, DeploymentUtils {
    function run() external {
        ...
        MetaHumanGovernor governanceContract = new MetaHumanGovernor(voteToken, timelockController, spokeContracts, hubChainId, sepoliaCoreBridgeAddress, deployerAddress);
